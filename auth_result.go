...
The following types satisfy this interface:
	...
	gitlab.com/nxcp/tools/gophercloud/openstack/identity/v2/tokens.CreateResult
	gitlab.com/nxcp/tools/gophercloud/openstack/identity/v3/tokens.CreateResult

Usage example:

	import (
		"gitlab.com/nxcp/tools/gophercloud"
		tokens2 "gitlab.com/nxcp/tools/gophercloud/openstack/identity/v2/tokens"
		tokens3 "gitlab.com/nxcp/tools/gophercloud/openstack/identity/v3/tokens"
	)
